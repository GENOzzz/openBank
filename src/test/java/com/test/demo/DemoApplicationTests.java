...
class DemoApplicationTests {
	...
	//CREATE TABLE TBL_LOGIN(LOGIN_KEY INTEGER PRIMARY KEY AUTOINCREMENT, LOGIN_ID TEXT NOT NULL, LOGIN_PASSWORD TEXT NOT NULL, INPUT_KEY INTEGER, INPUT_DATE INTEGER, UPDATE_KEY INTEGER, UPDATE_DATE INTEGER);
	//CREATE TABLE TBL_TOKEN(TOKEN_KEY INTEGER PRIMARY KEY AUTOINCREMENT,LOGIN_KEY INTEGER,TOKEN_TYPE TEXT NOT NULL,ACCESS_TOKEN TEXT NOT NULL,REFRESH_TOKEN TEXT NOT NULL,EXPIRES_IN INTEGER NOT NULL,SCOPE TEXT NOT NULL,USER_SEQ_NO INTEGER NOT NULL, INPUT_KEY INTEGER, INPUT_DATE datetime, UPDATE_KEY INTEGER, UPDATE_DATE datetime,FOREIGN KEY (LOGIN_KEY) REFERENCES TBL_LOGIN(LOGIN_KEY))
}
